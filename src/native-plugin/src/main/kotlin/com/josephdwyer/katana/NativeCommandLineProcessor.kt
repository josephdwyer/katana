...
class NativeCommandLineProcessor : CommandLineProcessor {
    ...
    /**
     * Just needs to be consistent with the getCompilerPluginId from gradle-plugin's KatanaSubplugin
     */
    override val pluginId: String = "com.josephdwyer.katana.plugin"
